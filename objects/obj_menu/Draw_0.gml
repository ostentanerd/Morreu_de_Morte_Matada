...
// Se estiver no Draw GUI, prefira display_get_gui_width() / 2 para alinhar com a tela
...
for (var i = 0; i < array_length(opcoes); i++) {
    ...
    // --- ALTERAÇÃO AQUI ---
    // Checa se o jogador já passou da primeira fase
    var _tem_progresso = (instance_exists(obj_controle) && obj_controle.fase_maxima > 1);
    
    // Bloqueia CONTINUAR (i == 0) e SELECIONAR FASE (i == 2) se não tiver progresso
    var _opcao_bloqueada = ((i == 0 || i == 2) && !_tem_progresso);
    // ----------------------
